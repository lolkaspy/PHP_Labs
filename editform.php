<?php 
$title = $titlehead = "Редактирование данных пользователя";
...
if(isset($_GET['id'])){
    ...
    <tr><td><label for='photo'>Аватар</label></td><td><img src='{$photo}'><input type='file' name='photo' accept='image/png, image/jpeg' size='20' maxlength='40'></td></tr>
    ...
    <tr><td><label for='position_option'>Выберите статус</label></td><td><select name='position'><option value='0'>Администратор</option><option value='1'>Студент</option><option value='2'>Обычный пользователь</option></select></td></tr>
